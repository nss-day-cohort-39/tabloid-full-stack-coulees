                                    ...
                                    ? tags.map((tag) => (
                                        <ListGroupItem key={tag.id} className="d-flex justify-content-between">
                                            ...
                                            <div className="d-flex justify-content-end">
                                                <Button color="secondary" size="sm" className="ml-2" onClick={() => { setChosenTag(tag); editModalToggle(); }}>Edit</Button>
                                                <Button color="secondary" size="sm" className="ml-2" onClick={() => { setChosenTag(tag); deleteModalToggle(); }}>Delete</Button>
                                            </div>
                                        </ListGroupItem>
                                    ))
